...
public class TestBeanFactory {
    ...
    public static void main(String[] args) {
        ...
        //beanFactory默认是没有解析注解的功能 证据就是 上面的方式创建这个config对象之后没有创建在配置类里面定义的bean
        ...
        beanFactory.getBeansOfType(BeanPostProcessor.class).values().stream()
            ...
            beanFactory.addBeanPostProcessor(beanPostProcessor);//beanFactory的后置处理器 与beanFactory建立联系
        });
