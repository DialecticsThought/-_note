        ...
        /*
            ...
            欢迎页处理
                a. WelcomePageHandlerMapping, 映射欢迎页(即只映射 '/')
                    ...
                    - 视图名固定为 forward:index.html       /**  这个路径会被 配置的ResourceHttpRequestHandler解析得到相应的控制器方法
                        这个控制器方法被 SimpleControllerHandlerAdapter调用会找到相应路径的静态资源
                b. SimpleControllerHandlerAdapter, 调用 handler（ParameterizableViewController）
        ...
        /*
            小结
                a. HandlerMapping 负责建立请求与控制器之间的映射关系
                    ...
                    - WelcomePageHandlerMapping    (/) 根路径  欢迎页
