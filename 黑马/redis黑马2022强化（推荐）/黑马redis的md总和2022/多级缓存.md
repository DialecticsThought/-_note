...
public class CaffeineConfig {
    ...
    public Cache<Long, Item> itemCache(){
        return Caffeine.newBuilder()
                .initialCapacity(100)//TODO 缓存初始大小为100
                .maximumSize(10_000)//TODO 缓存上限为10000 "_"为分隔符 方便阅读
                .build();
    }
...
测试：第一次浏览器访问 因为没有缓存，又会有访问mysql的log日志，第二次访问 有了缓存 没有相应的mysql的log日志
